...
import { loadGLTFModel } from '../lib/modelLoader';
import { BodyModel } from '../styles/Styled-Container'

// const ModelComponent = lazy(() => import("../public/low_poly_floating_tree.glb"));
...
export const Tree: React.FC = () => {
    ...
    useEffect(() => {
        ...
        if (container && !renderer) {
            ...
            loadGLTFModel(scene, "/low_poly_floating_tree.glb", {
                receiveShadow: false,
                castShadow: false,
            }).then(() => {
                animate();
